    ...
    if (!booking || 'error' in booking) {
        return (
            <div className="p-10 rounded-xl max-w-lg mx-auto mt-2 text-center shadow-lg">
                ...
                <h1 className="text-3xl font-semibold text-amber-600 mb-4">Booking Not Found</h1>
                <p className="text-gray-600 mb-6">The booking you are looking for doesn&apos;t exist or has been removed.</p>
                <Link href="/bookings">
                    <button className="inline-flex items-center px-6 py-3 bg-amber-600 text-white rounded-lg shadow-md hover:bg-amber-700 transition duration-300">
    ...
    return (
        <div className="max-w-screen-lg mx-auto px-4 pb-6">
            ...
            <div className="flex items-center justify-between mb-2">
                <Link href="/bookings">
                    <button className="flex items-center text-amber-600 hover:text-amber-800 transition duration-300">
                        <FaArrowLeft className="mr-2" />
                        Back to Bookings
                    </button>
                </Link>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                <div className="rounded-xl overflow-hidden shadow-lg relative lg:w-[476px] ">
                    ...
                    <div className="absolute top-4 left-4 text-white flex flex-col lg:flex-row md:items-left md:gap-4 w-full justify-between lg:pr-8">
                        ...
                        <Link href={`/rooms/${booking.room_id.$id}`} passHref>
                            <button
                                className="bg-amber-700 text-white px-4 py-2 rounded-md hover:bg-amber-600 transition-colors duration-300"
                            >
                                View Room
                            </button>
                        </Link>
                ...
                <div className="space-y-2">
                    <div className="bg-white shadow-lg rounded-xl p-4">
                        <h3 className="text-lg font-semibold text-amber-600 mb-2">Room Information</h3>
                    ...
                    <div className="bg-white shadow-lg rounded-xl p-4">
                        <h3 className="text-lg font-semibold text-amber-600 mb-2">Booking Dates</h3>
                        <div className="space-y-1 text-gray-700">
