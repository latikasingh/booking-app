  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      <header className="text-center mb-12">
        <h1 className="text-4xl sm:text-5xl font-bold text-amber-600 transition-all duration-500 ease-in-out hover:text-amber-800">
        ...
        <Link href={`/rooms`} passHref>
          <button className="mt-6 bg-amber-600 text-white py-3 px-8 rounded-full text-lg sm:text-xl transition-all duration-500 ease-in-out hover:bg-amber-700">
            Get Started
          </button>
        </Link>
      </header>
      ...
      <section className="mb-12">
        <h2 className="text-2xl sm:text-3xl font-semibold text-amber-600 mb-6 text-center">
      ...
      <section className="bg-amber-600 p-8 rounded-lg shadow-lg mb-12">
      ...
      <section className="bg-white p-8 rounded-lg shadow-lg mb-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="p-6 bg-gray-100 rounded-lg shadow-md hover:bg-amber-50 transition-all duration-500 ease-in-out">
            <h3 className="text-xl font-semibold text-amber-600">Easy Booking</h3>
            <p className="text-gray-700 mt-2">
              Quickly reserve meeting rooms with our user-friendly platform. No more hassle, just a few clicks!
            </p>
          </div>
          <div className="p-6 bg-gray-100 rounded-lg shadow-md hover:bg-amber-50 transition-all duration-500 ease-in-out">
            <h3 className="text-xl font-semibold text-amber-600">Real-time Availability</h3>
            <p className="text-gray-700 mt-2">
              See available rooms in real-time, ensuring you book a space that&apos;s free when you need it.
            </p>
          </div>
          <div className="p-6 bg-gray-100 rounded-lg shadow-md hover:bg-amber-50 transition-all duration-500 ease-in-out">
            <h3 className="text-xl font-semibold text-amber-600">Multiple Room Options</h3>
            <p className="text-gray-700 mt-2">
      ...
      {/* Call to Action */}
      <section className="bg-amber-600 p-8 text-center text-white rounded-lg shadow-lg mb-12">
        ...
        <Link href={`/rooms`} passHref>
          <button className="bg-white text-amber-600 py-3 px-6 rounded-full text-lg sm:text-xl transition-all duration-500 ease-in-out hover:bg-gray-100">
            Book a Room Now
          </button>
        </Link>
      </section>
