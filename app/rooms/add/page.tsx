            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="col-span-4 md:col-span-4 lg:col-span-4">
                    ...
                    <div className="flex flex-col md:flex-row space-x-2">
                        <div
                            className={`border-2 border-dashed p-8 rounded-lg text-center ${isDragActive ? "border-amber-500 bg-amber-50" : "border-gray-300"}`}
                ...
                <div className="col-span-4 md:col-span-4 lg:col-span-4 flex justify-center">
                    <button
                        type="submit"
                        className="w-full bg-amber-600 text-white py-3 rounded-lg hover:bg-amber-700 focus:outline-none focus:ring-2 focus:ring-amber-500 flex items-center justify-center text-lg font-semibold"
                    >
