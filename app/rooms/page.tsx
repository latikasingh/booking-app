    ...
    if (typedRooms.length === 0 || 'error' in rooms) {
        return (
            <div className="p-10 rounded-xl max-w-lg mx-auto mt-2 text-center shadow-lg">
                ...
                <h1 className="text-3xl font-semibold text-amber-600 mb-4">Rooms Not Available!</h1>
                <Link href={"/rooms/add"} passHref >
                    <button
                        className="inline-flex items-center px-6 py-3 bg-amber-600 text-white rounded-md shadow-md hover:bg-amber-700 transition duration-300"
                    >
