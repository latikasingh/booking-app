...
const Header: React.FC<HeaderProps> = ({ title = "Booking Rooms" }) => {
  ...
  return (
    <header className="bg-gradient-to-r from-amber-600 to-amber-900 text-white shadow-lg">
      <div className="px-6 py-4 flex items-center justify-between">
        <div className="flex items-center space-x-3">
          <Link href={"/"} className="flex items-center space-x-2 text-lg hover:text-amber-100 transition duration-300">
