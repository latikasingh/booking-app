        ...
        <div className="mt-4 mx-auto px-6 py-4 bg-white rounded-lg shadow-xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div className="flex flex-col">
                        ...
                        <input
                            ...
                            id="check_in_date"
                            name="check_in_date"
                            className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-600 transition duration-300"
                            required
                        />
                    </div>
                    <div className="flex flex-col">
                ...
                <div className="mt-8">
                    <button
                        type="submit"
                        className="w-full py-3 px-4 bg-amber-600 text-white font-semibold rounded-md hover:bg-amber-700 focus:outline-none focus:ring-4 focus:ring-amber-300 transition duration-300"
                    >
                        Confirm Booking
                    </button>
                </div>
